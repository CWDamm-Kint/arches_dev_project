...
APP_NAME = 'dev_project'
APP_ROOT = os.path.dirname(os.path.abspath(inspect.getfile(inspect.currentframe())))
STATICFILES_DIRS =  (os.path.join(APP_ROOT, 'media'),) + STATICFILES_DIRS

DATATYPE_LOCATIONS.append('dev_project.datatypes')
FUNCTION_LOCATIONS.append('dev_project.functions')
ETL_MODULE_LOCATIONS.append('dev_project.etl_modules')
SEARCH_COMPONENT_LOCATIONS.append('dev_project.search_components')
...
SECRET_KEY = '-ky2@vh-a+(mqys7y$cgihdqob-qsgz&z)k1+%6kjl7*m7z%hh'
...
ELASTICSEARCH_PREFIX = 'dev_project'

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'dev_project.search_indexes.sample_index.SampleIndex',
...
SESSION_COOKIE_NAME = 'dev_project'
